...
Plans:
**Wave 1**
- [ ] 12-01-PLAN.md — 建立 Phase 12 RED 契约，锁定 reality.log input-only parser、协议、路径安全、报告与原子写入行为。

**Wave 2** *(blocked on Wave 1 completion)*
- [ ] 12-02-PLAN.md — 实现可复用 Phase 12 CLI/wrapper，解析 reality.log、调用 Phase 11 GO GGUF 模型、缓存输出、验证并原子写入。

**Wave 3** *(blocked on Wave 2 completion)*
- [ ] 12-03-PLAN.md — 执行完整 426 条 reality replay，生成 reality_test.log 与 phase12_report.json，并进行最终门禁/人工抽查。
