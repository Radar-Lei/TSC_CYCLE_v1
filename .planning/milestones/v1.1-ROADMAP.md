...
- [x] **Phase 3: SFT 训练迁移** - 更新训练代码适配 GLM-4.7-Flash (BF16)，跑通端到端训练 (**被 Quick-2 超越**: Qwen3-4B SFT 完成)
- [x] **Phase 4: 模型导出与量化** - 导出 GGUF 格式 (F16 + Q4_K_M) (**被 Quick-2 超越**: F16/Q4_K_M GGUF 已导出)
...
Plans:
- [x] 03-01: 更新模型和 LoRA 配置 — 切换到 unsloth/GLM-4.7-Flash，配置 r=16/alpha=16/dropout=0
- [x] 03-02: ~~跑通端到端 SFT 训练~~ — **被 Quick-2 超越** (Qwen3-4B SFT 训练完成)
...
**Status**: **被 Quick-2 超越** — F16 (7.5GB) 和 Q4_K_M (2.4GB) GGUF 均已导出
**Plans**: 1 plan

Plans:
- [x] 04-01: ~~实现 GGUF 导出和量化流程~~ — **被 Quick-2 超越** (F16/Q4_K_M GGUF 已生成)
...
| 3. SFT 训练迁移 | v1.1 | 1/2 (Quick-2 超越) | Complete (Quick-2) | 2026-02-20 |
| 4. 模型导出与量化 | v1.1 | 0/1 (Quick-2 超越) | Complete (Quick-2) | 2026-02-20 |
