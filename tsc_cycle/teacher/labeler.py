...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--labeled", default="data/v3/phase2/labeled_new.jsonl")
    ap.add_argument("--rejected", default="data/v3/phase2/rejected_new.jsonl")
    ap.add_argument("--cost-out", default="data/v3/phase2/teacher_cost.latest.json")
    ap.add_argument("--reject-stats", default="data/v3/phase2/teacher_reject_stats.latest.json")
